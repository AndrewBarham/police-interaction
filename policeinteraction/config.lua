...
Config.MenuTitleCustom = 'D.P.D.O.J'
...
Config.LEOUniforms = {
    ...
    {name = '...', spawncode = 'bcso_new'},
    {name = '...', spawncode = 'fto'},
    {name = '...', spawncode = 'hp_new'},
    {name = '...', spawncode = 'sapd_new'},
